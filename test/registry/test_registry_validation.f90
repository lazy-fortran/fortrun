...
contains
  ...
  subroutine test_valid_registry()
    ...
    registry_path = '/tmp/test_valid_registry.toml'
  ...
  subroutine test_invalid_syntax()
    ...
    registry_path = '/tmp/test_invalid_syntax.toml'
  ...
  subroutine test_missing_fields()
    ...
    registry_path = '/tmp/test_missing_fields.toml'
  ...
  subroutine test_empty_registry()
    ...
    registry_path = '/tmp/test_empty_registry.toml'
