...
contains
  ...
  function test_registry_creation() result(passed)
    ...
    test_config_dir = '/tmp/test_registry_config'
  ...
  function test_registry_loading() result(passed)
    ...
    test_registry_path = '/tmp/test_registry_loading.toml'
  ...
  function test_module_resolution() result(passed)
    ...
    test_registry_path = '/tmp/test_resolution_registry.toml'
  ...
  function test_version_resolution() result(passed)
    ...
    test_registry_path = '/tmp/test_version_registry.toml'
  ...
  function test_registry_validation() result(passed)
    ...
    ! Test valid registry
    test_registry_path = '/tmp/test_valid_registry.toml'
    ...
    test_registry_path = '/tmp/test_invalid_registry.toml'
    ...
    call validate_registry('/tmp/definitely_nonexistent_registry.toml', is_valid, error_message)
    if (is_valid) then
    ...
    ! Clean up
    call execute_command_line('rm -f /tmp/test_*_registry.toml')
  ...
  function test_custom_registry_paths() result(passed)
    ...
    custom_config_dir = '/tmp/test_custom_registry_dir'
  ...
  function test_prefix_matching() result(passed)
    ...
    test_registry_path = '/tmp/test_prefix_registry.toml'
  ...
  function test_underscore_inference() result(passed)
    ...
    test_registry_path = '/tmp/test_underscore_registry.toml'
  ...
  function test_error_handling() result(passed)
    ...
    call load_registry_from_path('/tmp/definitely_nonexistent_registry.toml')
  ...
  function test_edge_cases() result(passed)
    ...
    test_registry_path = '/tmp/test_edge_registry.toml'
