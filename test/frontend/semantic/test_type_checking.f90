...
contains
    ...
    subroutine test_numeric_promotion()
        ...
        int_val = create_literal(LITERAL_INTEGER, "42", 1, 10)
        real_val = create_literal(LITERAL_REAL, "3.14", 1, 15)
    ...
    subroutine test_intrinsic_functions()
        ...
        real_arg = create_literal(LITERAL_REAL, "4.0", 1, 10)
        ...
        if (typ%kind == TREAL) then
            ...
            real_arg = create_literal(LITERAL_REAL, "4.5", 3, 10)
