...
contains
    ...
    subroutine test_basic_execution(passed)
        ...
        test_cache_dir = "/tmp/test_notebook_executor"
...
99      continue
    ...
    subroutine test_multiple_cell_execution(passed)
        ...
        ! Set up test cache directory
        test_cache_dir = "/tmp/test_notebook_executor_multi"
        call execute_command_line("mkdir -p " // trim(test_cache_dir))
...
99      continue
    ...
    subroutine test_error_handling(passed)
        ...
        ! Set up test cache directory
        test_cache_dir = "/tmp/test_notebook_executor_error"
        call execute_command_line("mkdir -p " // trim(test_cache_dir))
...
99      continue
    ...
    subroutine test_cache_directory_usage(passed)
        ...
        test_cache_dir = "/tmp/test_notebook_executor_cache_test"
        call execute_command_line("rm -rf " // trim(test_cache_dir))
...
99      continue
    ...
    subroutine test_empty_notebook(passed)
        ...
        ! Set up test cache directory
        test_cache_dir = "/tmp/test_notebook_executor_empty"
        call execute_command_line("mkdir -p " // trim(test_cache_dir))
...
99      continue
    ...
    subroutine test_mixed_cell_types(passed)
        ...
        ! Set up test cache directory
        test_cache_dir = "/tmp/test_notebook_executor_mixed"
        call execute_command_line("mkdir -p " // trim(test_cache_dir))
