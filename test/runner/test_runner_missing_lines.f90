...
contains
    ...
    function test_preprocessed_file_missing() result(passed)
        logical :: passed
        character(len=:), allocatable :: lf_file, cache_dir
        integer :: exit_code, unit
        character(len=256) :: custom_cache_dir, custom_config_dir
        logical :: success
        ...
        ! Create .lf file to trigger preprocessor
        lf_file = temp_mgr%get_file_path('missing_preprocess.lf')
        ...
        call sys_remove_dir(cache_dir, success)
