program test_runner_comprehensive
    ...
    ! Test 4: .lf file preprocessing
    if (.not. test_lf_file_preprocessing()) all_tests_passed = .false.
...
contains
    ...
    function test_lf_file_preprocessing() result(passed)
        logical :: passed
        integer :: exit_code
        character(len=:), allocatable :: test_file
        integer :: unit
        ...
        print *, "Test 4: .lf file preprocessing"

        ! Create temporary directory and .lf file
        call temp_dir%create('test_preprocess')
        test_file = temp_dir%get_file_path('test_preprocess.lf')
        ...
        if (exit_code == 0) then
            print *, "  PASS: .lf file preprocessing successful"
            passed = .true.
        else
            print *, "  FAIL: Expected exit code 0, got ", exit_code
            passed = .false.
    ...
    end function test_lf_file_preprocessing
