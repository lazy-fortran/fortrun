program test_examples
    ...
    n_examples = 27  ! reduced from 33, removed notebook examples
    allocate (example_files(n_examples))

    ! Hello examples (.f90 and .lf versions)
    example_files(1) = 'example/basic/hello/hello.f90'
    example_files(2) = 'example/basic/hello/hello.lf'

    ! Calculator examples (.f90 and .lf versions)
    example_files(3) = 'example/basic/calculator/calculator.f90'
    example_files(4) = 'example/basic/calculator/calculator.lf'

    ! Precision examples (.f90 and .lf versions)
    example_files(5) = 'example/scientific/precision/precision_test.f90'
    example_files(6) = 'example/scientific/precision/precision_test.lf'
    example_files(7) = 'example/scientific/precision/precision_compare.f90'
    example_files(8) = 'example/scientific/precision/precision_compare.lf'
    example_files(9) = 'example/scientific/precision/real_default_test.f90'
    example_files(10) = 'example/scientific/precision/real_default_test.lf'

    ! Interdependent examples (.f90 and .lf versions)
    example_files(11) = 'example/modules/interdependent/main.f90'
    example_files(12) = 'example/modules/interdependent/main.lf'

    ! Type inference examples
    example_files(13) = 'example/fortran/type_inference/calculate.f90'
    example_files(14) = 'example/fortran/type_inference/calculate.lf'
    example_files(15) = 'example/fortran/type_inference/all_types.f90'
    example_files(16) = 'example/fortran/type_inference/all_types.lf'

    ! Advanced inference examples
    example_files(17) = 'example/fortran/advanced_inference/arrays.f90'
    example_files(18) = 'example/fortran/advanced_inference/arrays.lf'
    example_files(19) = 'example/fortran/advanced_inference/derived_types.f90'
    example_files(20) = 'example/fortran/advanced_inference/derived_types.lf'

    ! Notebook examples - moved to fnb package, skip these
    ! example_files(21) = 'example/scientific/notebook/simple_math.f90'
    ! example_files(22) = 'example/scientific/notebook/simple_math.lf'
    ! example_files(23) = 'example/scientific/notebook/arrays_loops.f90'
    ! example_files(24) = 'example/scientific/notebook/arrays_loops_simple.lf'
    ! example_files(25) = 'example/scientific/notebook/control_flow.f90'
    ! example_files(26) = 'example/scientific/notebook/control_flow_simple.lf'

    ! Step 1 explicit types examples (our new Step 1 work)
    example_files(21) = 'example/fortran/step1_explicit_types/step1_demo.lf'
    example_files(22) = 'example/fortran/step1_explicit_types/comprehensive_step1.lf'

    ! Advanced inference function returns and intrinsics
    example_files(23) = 'example/fortran/advanced_inference/function_returns.f90'
    example_files(24) = 'example/fortran/advanced_inference/function_returns.lf'
    example_files(25) = 'example/fortran/advanced_inference/intrinsic_functions.f90'
    example_files(26) = 'example/fortran/advanced_inference/intrinsic_functions.lf'

    ! Plotting examples (may have external deps but should be testable)
    example_files(27) = 'example/scientific/plotting/plot_demo.f90'

    ! List of expected failures - .lf files with known preprocessor issues and module dependency examples
    ! These require advanced type inference, complex syntax support, or module dependency discovery
    n_expected_failures = 9
    allocate (expected_failures(n_expected_failures))
    expected_failures(1) = 'example/fortran/advanced_inference/arrays.lf'              ! Complex array type inference
    expected_failures(2) = 'example/fortran/advanced_inference/derived_types.lf'       ! Derived type syntax
expected_failures(3) = 'example/fortran/step1_explicit_types/step1_demo.lf'           ! Preprocessor issue with .lf files
    expected_failures(4) = 'example/fortran/advanced_inference/function_returns.lf'    ! Function interfaces
    expected_failures(5) = 'example/basic/calculator/calculator.lf'                    ! Preprocessor issue with .lf files
    expected_failures(6) = 'example/modules/interdependent/main.lf'                    ! Preprocessor issue with .lf files
    ...
    expected_failures(9) = 'example/scientific/plotting/plot_demo.f90'                ! Requires pyplot_module external dependency
    ...
    do i = 1, n_examples
        ...
        if (exit_code == 0) then
            ...
            case ('example/basic/hello/hello.f90', 'example/basic/hello/hello.lf')
                if (index(output, 'Hello from fortran CLI!') == 0) then
                    print '(a)', '    WARNING: Expected output not found'
                end if

           case ('example/basic/calculator/calculator.f90', 'example/basic/calculator/calculator.lf')
            ...
            case ('example/scientific/precision/real_default_test.lf')
              if (index(output, 'sizeof(real) =                     8  bytes') > 0) then
                    print '(a)', '    ✓ Opinionated double precision confirmed (.lf)'
                else
               print '(a)', '    WARNING: Opinionated precision not working as expected'
                end if

            case ('example/modules/interdependent/main.f90', 'example/modules/interdependent/main.lf')
     ...
     case ('example/fortran/type_inference/calculate.f90', 'example/fortran/type_inference/calculate.lf')
     ...
     case ('example/fortran/type_inference/all_types.f90', 'example/fortran/type_inference/all_types.lf')
   ...
   case ('example/fortran/advanced_inference/arrays.f90', 'example/fortran/advanced_inference/arrays.lf')
            ...
            case ('example/scientific/notebook/simple_math.f90', 'example/scientific/notebook/simple_math.lf')
      ...
      case ('example/fortran/step1_explicit_types/step1_demo.f90', 'example/fortran/step1_explicit_types/step1_demo.lf')
      ...
      case ('example/advanced_inference/function_returns.f90', 'example/advanced_inference/function_returns.lf')
      ...
      case ('example/advanced_inference/intrinsic_functions.f90', 'example/advanced_inference/intrinsic_functions.lf')
    ...
    ! Test that .lf files generate expected .f90 output
    ...
    if (n_failed > 0) then
        ...
        if (n_expected_failed > 0) then
            print '(a)', 'OVERALL: PASSED (with expected failures in .lf preprocessor)'
        else
...
contains
   ...
   'fpm run fortrun -- --cache-dir "'//trim(escape_shell_arg(temp_cache_dir))//'" "'// &
...
999     continue
    ...
    subroutine run_example_with_cache(filename, cache_dir, output, exit_code)
      ...
      'fpm run fortrun -- -v --cache-dir "'//trim(escape_shell_arg(cache_dir))//'" '// &
                  trim(escape_shell_arg(filename))//' > "'//trim(escape_shell_arg(temp_output_file))//'" 2>&1'
        call execute_command_line(trim(command), exitstat=exit_code)
    ...
    subroutine run_example_for_comparison(filename, cache_dir, output, exit_code)
        ...
        if (get_os_type() == OS_WINDOWS) then
            ...
            ! Unix version
            command = 'cd "'//trim(escape_shell_arg(get_project_root()))//'" && '// &
         'fpm run fortrun -- --cache-dir "'//trim(escape_shell_arg(cache_dir))//'" '// &
...
999     continue
    ...
    subroutine test_preprocessor_output_correctness(n_passed, n_failed)
        ...
        print '(a)', '='//repeat('=', 60)
        print '(a)', 'Testing .lf to .f90 Preprocessor Output Correctness'
        print '(a)', '='//repeat('=', 60)
        print *
        ...
        ! Test pairs of .lf and .f90 files that should produce identical output
  call test_file_pair('example/basic/hello/hello.lf', 'example/basic/hello/hello.f90', &
                            temp_cache_dir, n_passed, n_failed)

    call test_file_pair('example/basic/calculator/calculator.lf', 'example/basic/calculator/calculator.f90', &
                            temp_cache_dir, n_passed, n_failed)

    call test_file_pair('example/fortran/type_inference/calculate.lf', 'example/fortran/type_inference/calculate.f90', &
                            temp_cache_dir, n_passed, n_failed)

    call test_file_pair('example/fortran/type_inference/all_types.lf', 'example/fortran/type_inference/all_types.f90', &
                            temp_cache_dir, n_passed, n_failed)
    ...
    subroutine test_file_pair(f_file, f90_file, cache_dir, n_passed, n_failed)
        ...
        if (outputs_match(f_output, f90_output)) then
            ...
            print '(a,a)', '    .lf output:   ', trim(f_output)
    ...
    function is_f_file_expected_failure(filename) result(is_expected)
        ...
        character(len=256), parameter :: expected_f_failures(4) = [ &
                     'example/basic/hello/hello.lf                                  ', &
                     'example/basic/calculator/calculator.lf                        ', &
                     'example/fortran/type_inference/calculate.lf                   ', &
                       'example/fortran/type_inference/all_types.lf                   ']
        integer :: i
